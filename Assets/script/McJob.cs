...
{ 
    ...
    static public class Mc
    {
        ...
        static public bool SampleAllCubes(
            ref this (
                NativeArray<CubeLine> current___,
                NativeArray<CubeLine> current___right,
                NativeArray<CubeLine> back______,
                NativeArray<CubeLine> back______right,
                NativeArray<CubeLine> under_____,
                NativeArray<CubeLine> under_____right,
                NativeArray<CubeLine> backUnder_,
                NativeArray<CubeLine> backUnder_right
            ) g,
            int gridId,
        ...
        [MethodImpl( MethodImplOptions.AggressiveInlining )]
        static uint bitwiseHalfCubeLineX_( uint y0z0r, uint y0z1r, uint y1z0r, uint y1z1r )
        {
